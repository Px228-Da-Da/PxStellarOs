...
class CustomContextMenu(QMenu):
    def __init__(self, parent=None, widget_type="text"):
    ...
    def setup_actions(self):
        ...
        # Основные действия
        self.cut_action = QAction("✂️ Вырезать", self)
        ...
        self.delete_action = QAction("🗑️ Удалить", self)
...
class CustomContextMenu_cmd(QMenu):
    ...
    def setup_style(self):
        ...
        self.setStyleSheet("""
            ...
            CustomContextMenu_cmd::item:disabled {
                color: #666666;
            }
            CustomContextMenu_cmd::separator {
                height: 1px;
                background: #555;
                margin: 5px 12px;
            }
            CustomContextMenu_cmd::right-arrow {
                margin-right: 5px;
            }
        """)
